...
public class AllSchedulesFragment extends Fragment implements ScheduleAdapter.OnScheduleClickListener {
    ...
    private int currentStatus = -1; // -1: All, 0: Pending, 1: Completed
    ...
    private void loadSchedules() {
        List<Schedule> schedules = dbHelper.searchSchedules(currentQuery, -1, currentStatus);
